...
while ( $novel = DB::fetch( $query ) )
{
		...
		{
				$novel['upid'] = $novel['catid'];
				$novel['upname'] = $novel['catname'];
		}
...
$multi = multipage( $novelcount, $perpage, $page, "pdnovel.php?mod=list&catid=".$catid.( "&full=".$full."&words={$words}&update={$update}&letter={$letter}&orderby={$orderby}" ) );
$nccup = $ncc[$catid]['upid'];
$query = DB::query( "SELECT * FROM ".DB::table( "pdnovel_category" )." WHERE upid=0" );
loadcache( "diytemplatename" );
if ( $pdmodule['rewrite'] != 0 )
{
		$selectul = "<li><a href=\"novel-list-0-".$full."-".$words."-".$update."-".$letter."-".$orderby."-".$show.".html\" ".( $catid == 0 ? "class=\"licurrent\"" : "class=\"hand1\"" )." title=\"".$lang['list_all']."\">".$lang['list_all']."</a></li>";
		while ( $nccul = DB::fetch( $query ) )
		{
				$selectul .= "<li><a href=\"novel-list-".$nccul['catid']."-".$full."-".$words."-".$update."-".$letter."-".$orderby."-".$show.".html\" ".( $catid == $nccul['catid'] ? "class=\"licurrent\"" : "class=\"hand1\"" )." title=\"".$nccul['catname']."\">".$nccul['catname']."</a></li>";
		}
		if ( $nccup == 0 )
		{
						$selectyy = "<li><a href=\"novel-list-".$catid."-".$full."-".$words."-".$update."-".$letter."-".$orderby."-".$show.".html\" class=\"selectfont\" title=\"".$lang['list_all']."\">".$lang['list_all']."</a></li>";
						foreach ( $ncc[$catid][children] as $nccyy )
						{
								$selectyy .= "<li><a href=\"novel-list-".$nccyy."-".$full."-".$words."-".$update."-".$letter."-".$orderby."-".$show.".html\" class=\"hand1\" title=\"".$ncc[$nccyy][caption]."\">".$ncc[$nccyy]['catname']."</a></li>";
						}
		}
		else
		{
						$selectyy = "<li><a href=\"novel-list-".$nccup."-".$full."-".$words."-".$update."-".$letter."-".$orderby."-".$show.".html\" class=\"hand1\" title=\"".$lang['list_all']."\">".$lang['list_all']."</a></li>";
						foreach ( $ncc[$nccup][children] as $nccyy )
						{
								...
								$selectyy .= "<li><a href=\"novel-list-".$nccyy."-".$full."-".$words."-".$update."-".$letter."-".$orderby."-".$show.".html\" ".( $catid == $nccyy ? "class=\"selectfont\"" : "class=\"hand1\"" )." title=\"".$ncc[$nccyy][caption]."\">".$ncc[$nccyy]['catname']."</a></li>";
						}
		}
		include( template( "diy:pdnovel/rewrite/list" ) );
}
else
{
		$selectul = "<li><a href=\"pdnovel.php?mod=list&catid=0&full=".$full."&words=".$words."&update=".$update."&letter=".$letter."&orderby=".$orderby."&show=".$show."\" ".( $catid == 0 ? "class=\"licurrent\"" : "class=\"hand1\"" )." title=\"".$lang['list_all']."\">".$lang['list_all']."</a></li>";
		while ( $nccul = DB::fetch( $query ) )
		{
				$selectul .= "<li><a href=\"pdnovel.php?mod=list&catid=".$nccul['catid']."&full=".$full."&words=".$words."&update=".$update."&letter=".$letter."&orderby=".$orderby."&show=".$show."\" ".( $catid == $nccul['catid'] ? "class=\"licurrent\"" : "class=\"hand1\"" )." title=\"".$nccul['catname']."\">".$nccul['catname']."</a></li>";
		}
		if ( $nccup == 0 )
		{
						$selectyy = "<li><a href=\"pdnovel.php?mod=list&catid=".$catid."&full=".$full."&words=".$words."&update=".$update."&letter=".$letter."&orderby=".$orderby."&show=".$show."\" class=\"selectfont\" title=\"".$lang['list_all']."\">".$lang['list_all']."</a></li>";
						foreach ( $ncc[$catid][children] as $nccyy )
						{
								$selectyy .= "<li><a href=\"pdnovel.php?mod=list&catid=".$nccyy."&full=".$full."&words=".$words."&update=".$update."&letter=".$letter."&orderby=".$orderby."&show=".$show."\" class=\"hand1\" title=\"".$ncc[$nccyy][caption]."\">".$ncc[$nccyy]['catname']."</a></li>";
						}
		}
		else
		{
				$selectyy = "<li><a href=\"pdnovel.php?mod=list&catid=".$nccup."&full=".$full."&words=".$words."&update=".$update."&letter=".$letter."&orderby=".$orderby."&show=".$show."\" class=\"hand1\" title=\"".$lang['list_all']."\">".$lang['list_all']."</a></li>";
				foreach ( $ncc[$nccup][children] as $nccyy )
				{
						$selectyy .= "<li><a href=\"pdnovel.php?mod=list&catid=".$nccyy."&full=".$full."&words=".$words."&update=".$update."&letter=".$letter."&orderby=".$orderby."&show=".$show."\" ".( $catid == $nccyy ? "class=\"selectfont\"" : "class=\"hand1\"" )." title=\"".$ncc[$nccyy][caption]."\">".$ncc[$nccyy]['catname']."</a></li>";
				}
		}
